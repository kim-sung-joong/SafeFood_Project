...
@ComponentScan(basePackageClasses= {MemberRepository.class, FoodService.class, EatService.class, MemberService.class, FoodRepository.class, EatRepository.class , QnaRepository.class, QnaService.class, NoticeRepository.class, NoticeService.class}) // Bean 객체 관리요청
